...
## Description of the Statechart with Lucy DSL in VSCode
...
## VSCode XState No Code Statechart Diagram
...
## Celonis Process Mining Using The Event Log Derived From the App
...
## Visualization of Input State Regexp
#### ^-?\d+(\.\d+)? [+−×÷] -?\d+\.?\d*$
